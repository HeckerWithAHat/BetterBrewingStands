...
public final class BetterBrewingStands extends JavaPlugin {
    ...
    public static final FullItem LEVEL_BLOCK = new FullItem(
            org.bukkit.Material.DIAMOND_BLOCK,
            1,
            "Level Upgrade Block",
            new String[]{
                    "This block is used to upgrade brewing stands",
                    "Place it next to a brewing stand to upgrade it",
                    "Provide it with a redstone signal to deactivate it",
                    "Increases the potency of all potions brewed in the stand"
            },
            true,
            1
    );
    ...
    public boolean onCommand(org.bukkit.command.CommandSender sender, org.bukkit.command.Command command, String label, String[] args) {
        ...
        if (command.getName().equalsIgnoreCase("bbs")) {
            sender.sendMessage("BetterBrewingStands is running!");
            return true;
        }
        if (command.getName().equalsIgnoreCase("levelfear")) {
